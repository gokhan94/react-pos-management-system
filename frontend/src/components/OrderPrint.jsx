 ...
 const handlePrint = useReactToPrint({
  ...
  return (
    <>
          ...
          <div ref={componentRef} style={{ width: '100%', height: '100vh' }}>
			...
			<div className="invoice">
				...
				<div className="i_to">
					...
					<p  className='c_detail'>{ order.country }, { order.province }</p>
					</div>
				...
				<div className="i_payment">
					...
					<div className="p_title">
					<p className='c_detail'>Card Payment:</p>
					<span className='o_detail'>Visa, Paypal</span>
					</div>
				</div>
				</div>
      ...
      <button className='order-status' onClick={handlePrint}> Print </button>
      </>
  )
}
