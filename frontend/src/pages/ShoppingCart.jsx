...
import { increase, decrease, productSubTotal, productTotalAmount, productTax, removeCartItem } from '../features/cart/cartSlice'
  ...
  return (
          <div className='cart'>
            ...
            <div className='cart-empty'>
              ...
              {cartItems ? cartItems.map((cart) => 
                <div className='cart-items' key={cart.id}>
                  <div className='image'>
                    {cart.image ? <img className='product-image' src={cart.image} alt='...' />
                    :
                    <img className='default-image' src={require('../images/product.png')} alt='...' />
                        ...
                        <div className='info'>
                            ...
                            <button className='remove-item' type='button' onClick={() => { dispatch(removeCartItem(cart.id)) }}>X</button>
                            ...
                            <div className='details'>
                                ...
                                <div className='count'>
                                    <button className='increment-btn' type='button' onClick={() => { dispatch(increase(cart.id)) }}>+</button>
                                    <span className='amount'>{ cart.quantity }</span>
                                    <button className='decrement-btn' type='button' onClick={() => { dispatch(decrease(cart.id)) }}>-</button>
                                </div>
            ...
            <div className='total-card'>
              ...
              <div className='pay'>  
                <button className='pay-btn' onClick={() => navigate('/cart')}>Checkout</button>
              </div>
            </div>
